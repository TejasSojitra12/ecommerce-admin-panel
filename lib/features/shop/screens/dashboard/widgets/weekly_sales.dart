...
class TWeeklySalesGraph extends StatelessWidget {
        ...
        children: [
          ...
          Obx(
            ()=> controller.weeklySales.isNotEmpty ? SizedBox(
              ...
              child: BarChart(
                BarChartData(
                    titlesData: buildTitleData(controller.weeklySales),
  ...
  FlTitlesData buildTitleData(List<double> weeklySales) {
    ...
    return FlTitlesData(
      ...
      bottomTitles: AxisTitles(
        ...
        getTitlesWidget: (value, meta) {
          ...
          // Get the day corresponding to the actual day
      ...
      leftTitles:  AxisTitles(
          sideTitles:
              SideTitles(showTitles: true, interval: stepHeight <= 0 ? 500 : stepHeight, reservedSize: 50)),
