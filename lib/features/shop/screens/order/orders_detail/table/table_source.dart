...
class OrderRows extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    final order = DashboardController.instance.filteredItems[index];
    return DataRow2(
      ...
      DataCell(TTableActionButtons(
        view: true,
        edit: false,
        onViewPressed: () => Get.toNamed(TRoutes.ordersDetails,arguments: order),
        onDeletePressed: (){},
      )),
    ]);
  }
  ...
  @override
  int get rowCount => DashboardController.instance.filteredItems.length;

  @override
  int get selectedRowCount => DashboardController.instance.selectedRows.where((element) => element).length;
}
